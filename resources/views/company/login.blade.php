...
<body>
    <form action="{{ route('company.store') }}" id="is_validate_form" method="post"
            ...
            <div class="p-12 md:p-24">
                <div class="flex items-center text-lg mb-6 md:mb-8">
                    ...
                    data-rule-email="true" data-rule-required="true"
                        class="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="email" />
                ...
                <div class="flex items-center text-lg mb-6 md:mb-8">
                    ...
                    data-rule-minLength="8" data-rule-required="true"
